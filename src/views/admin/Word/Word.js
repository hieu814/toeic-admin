...
import { useDeleteWordMutation, useFindAllWordMutation, useBulkInsertWordMutation } from "src/api/word";
import MyTable from "./components/WordTable";
import { buidQuery, getPaginator } from "src/common/Funtion";
import WordModal from "./components/WordModal";
import { useFindAllWordCategoriesMutation, useGetWordCategoryQuery } from "src/api/word_category";
...
const WordManagementPage = () => {
    ...
    const { data: currentCategory } = useGetWordCategoryQuery(category || "");
    ...
    }, [findAllWords, search, type, rowsPerPage]);
    const loadData = () => {
        try {
            var _query = {}
    ...
    const importWord = () => {
        var json = {
            name: "saddasdas",
            mean: "11111111111111111",
            image: "asdadsa",
            definition: "adssd",
            example: "asdasd",
            pronounce: "asd",
            type: "1111111111111222",
